...
<div class="container">
    ...
    <hr class="separator"/>
    <p>@lang("Check your log for more details.") ({{ isset($log_file) ? $log_file : 'pharusnms.log' }})</p>

    <p>@lang("If you need additional help, you can find how to get help at") <a target="_blank" href="http://pharusnms.com/Support">https://pharusnms.com/Support</a> or email to <b>destek@arya-it.com</b></p>
</div>
</body>
</html>
