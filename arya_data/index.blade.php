...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-6">
            ...
            <h3>@lang('Pharus NMS is Network Monitoring System')</h3>
            <table class='table table-condensed table-hover'>
                <tr>
                    <td><b>@lang('Version')</b></td>
                    <td><a target="_blank" href='http://www.pharusnms.com'>{{ $version_local }}<span id='version_date' style="display: none;">{{ $git_date }}</span></a></td>
                </tr>
                <tr>
            ...
            <p>
<!--            <h3>@lang('Pharus NMS is a Arya IT Project')</h3>
...
-->
          ...
          <b>Mustafa Demiröz</b> Collectd code.<br />
          <b>Arya IT Software Development</b> Application monitors for PowerDNS, Shoutcast, NTPD (Client, Server).<br />
          <b>Observium, Zabbix, OpenNMS and Libre </b> Codebase for fork.<br />
